...
export const followSuccess = (userID: number) => ({type: 'FOLLOW', userID: userID})
...
export const toogleFollowProgress=(followInProgress:boolean,userId:number):toogleFollowProgressType=>{
